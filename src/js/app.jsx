  ...
  render() {
    return (
      <div className='App'>
        ...
        <input onChange={this.handleChange} name='principal' placeholder='Principal'/>
        <input onChange={this.handleChange} name='interestRate' placeholder='APR'/>
        <input onChange={this.handleChange} name='loanTerm' placeholder='Loan Term in Years'/>
